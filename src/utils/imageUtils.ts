...
export async function getCroppedImg(
  ...
  // set canvas width to final desired crop size - also can resize here
  canvas.width = outputWidth;
  canvas.height = outputHeight;

  // Use an intermediate canvas for resizing if needed, 
  // but for simplicity we can just put the data into a temporary canvas 
  // and then draw it scaled to the main canvas.
